...
RcppExport SEXP _svcov_cov_rns(SEXP thetaSEXP, SEXP locsSEXP, SEXP x_covariatesSEXP, SEXP smooth_limitsSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _svcov_cov_rns_pred(SEXP thetaSEXP, SEXP locsSEXP, SEXP locs_predSEXP, SEXP x_covariatesSEXP, SEXP x_covariates_predSEXP, SEXP smooth_limitsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List& >::type theta(thetaSEXP);
...
RcppExport SEXP _svcov_cov_rns_classic(SEXP thetaSEXP, SEXP locsSEXP, SEXP x_covariatesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List& >::type theta(thetaSEXP);
...
RcppExport SEXP _svcov_cov_rns_classic_prod_smooth(SEXP thetaSEXP, SEXP locsSEXP, SEXP x_covariatesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List& >::type theta(thetaSEXP);
...
RcppExport SEXP _svcov_cov_rns_taper_optimized_predict_range(SEXP thetaSEXP, SEXP locsSEXP, SEXP locs_predSEXP, SEXP x_covariatesSEXP, SEXP x_covariates_predSEXP, SEXP colindicesSEXP, SEXP rowpointersSEXP, SEXP smooth_limitsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List& >::type theta(thetaSEXP);
...
RcppExport SEXP _svcov_cov_rns_taper_optimized_range(SEXP thetaSEXP, SEXP locsSEXP, SEXP x_covariatesSEXP, SEXP colindicesSEXP, SEXP rowpointersSEXP, SEXP smooth_limitsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List& >::type theta(thetaSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_svcov_cov_rns", (DL_FUNC) &_svcov_cov_rns, 4},
    {"_svcov_cov_rns_pred", (DL_FUNC) &_svcov_cov_rns_pred, 6},
    {"_svcov_cov_rns_classic", (DL_FUNC) &_svcov_cov_rns_classic, 3},
    {"_svcov_cov_rns_classic_prod_smooth", (DL_FUNC) &_svcov_cov_rns_classic_prod_smooth, 3},
    {"_svcov_cov_rns_taper_optimized_predict_range", (DL_FUNC) &_svcov_cov_rns_taper_optimized_predict_range, 8},
    {"_svcov_cov_rns_taper_optimized_range", (DL_FUNC) &_svcov_cov_rns_taper_optimized_range, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_svcov(DllInfo *dll) {
